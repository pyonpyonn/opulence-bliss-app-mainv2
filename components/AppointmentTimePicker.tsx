...
export default function AppointmentTimePicker({
  ...
  return (
    <section style={{ border: "1px solid #dfd1f4", borderRadius: 18, padding: 20, background: "#fff", color: "#241b2f" }} aria-label="Appointment date and time">
      ...
      <p style={{ fontSize: 13, color: "#736a7d" }}>Appointments run between 7:00 AM and 8:00 PM, London time. The available start times make sure your full visit finishes by 8:00 PM. Choose the time that suits you; cleaner matching follows booking.</p>
