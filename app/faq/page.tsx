...
const faqGroups: Array<{
...
}> = [
  {
    ...
    items: [
      ["When can I book a cleaning visit?", "You can place a booking online at any time. Cleaning visits run between 7:00 am and 8:00 pm in 30-minute steps, and the available start times ensure the full visit finishes by 8:00 pm. Same-day bookings need at least two hours of notice; professional matching follows booking."],
