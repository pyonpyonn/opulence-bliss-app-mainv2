...
- A 2.5-hour clean costs 1.25 times a 2-hour package; invalid duration/size requests fail at checkout. Try a start that finishes exactly at 20:00, one that finishes after 20:00, 06:30 and 12:45.
