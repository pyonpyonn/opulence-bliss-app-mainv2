-- Customers may book online at any time. The complete appointment must fit
-- inside the 07:00-20:00 Europe/London service window.
...
alter table public.booking_rules
  ...
  alter column appointment_end_hour set default 20;
...
begin
  ...
  if v_rules.appointment_start_hour <> 7
     or v_rules.appointment_end_hour <> 20 then
    raise exception 'appointment window must be 07:00-20:00';
  end if;
end
$verify$;
