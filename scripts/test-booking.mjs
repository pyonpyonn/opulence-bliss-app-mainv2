...
const modules = ["appointmentWindow", "bookingPolicy", "bookingTimeChoices", "cancellationPolicy", "cleaningBooking", "messageAttachments", "providerDbs", "providerOnboarding", "providerOperations", "regularBooking", "reviewVisibility", "visitStatus"];
try {
