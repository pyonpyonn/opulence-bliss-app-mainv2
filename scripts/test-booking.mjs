...
const modules = ["appointmentWindow", "bookingPolicy", "bookingTimeChoices", "cancellationPolicy", "cleaningBooking", "messageAttachments", "providerDbs", "providerOnboarding", "providerOperations", "reviewVisibility", "visitStatus"];
try {
