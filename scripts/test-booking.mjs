...
const modules = ["appointmentWindow", "bookingTimeChoices", "cancellationPolicy", "cleaningBooking", "messageAttachments", "providerDbs", "providerOnboarding", "providerOperations", "reviewVisibility", "visitStatus"];
try {
