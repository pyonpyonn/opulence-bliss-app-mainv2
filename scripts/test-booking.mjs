...
const modules = ["appointmentWindow", "bookingTimeChoices", "cancellationPolicy", "cleaningBooking", "messageAttachments", "providerOperations", "reviewVisibility", "visitStatus"];
try {
