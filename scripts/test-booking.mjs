...
const modules = ["appointmentWindow", "bookingTimeChoices", "cancellationPolicy", "cleaningBooking", "messageAttachments", "providerOnboarding", "providerOperations", "reviewVisibility", "visitStatus"];
try {
